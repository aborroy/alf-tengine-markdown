...
import org.alfresco.transformer.executors.MarkdownToPdfTransformerExecutor;
...
public class TransformerController extends AbstractTransformerController {
    ...
    @Autowired
    private MarkdownToPdfTransformerExecutor javaExecutor;
    ...
    public ProbeTestTransform getProbeTestTransform() {
        ...
        return new ProbeTestTransform(this, "quick.md", "quick2.pdf",
